...
#define m_HWC_BLEND_FACTOR     (15<<28)
#define m_W2_BLEND_FACTOR     (0xff<<20)
#define m_W1_BLEND_FACTOR     (0xff<<12)
#define m_W0_BLEND_FACTOR     (0xff<<4)

#define v_HWC_BLEND_EN(x)         (((x)&1)<<3)
#define v_W2_BLEND_EN(x)          (((x)&1)<<2)
#define v_W1_BLEND_EN(x)          (((x)&1)<<1)
#define v_W0_BLEND_EN(x)          (((x)&1)<<0)
#define v_HWC_BLEND_FACTOR(x)    (((x)&15)<<28)
#define v_W2_BLEND_FACTOR(x)     (((x)&0xff)<<20)
#define v_W1_BLEND_FACTOR(x)     (((x)&0xff)<<12)
#define v_W0_BLEND_FACTOR(x)     (((x)&0xff)<<4)
